    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          offers: [
            ...
            { "@type": "Offer", name: "Growth", price: "599", priceCurrency: "ZAR" },
          ],
        }),
      },
    ],
...
const plans: Plan[] = [
  {
    ...
    price: "R0",
    period: "per month",
    description: "Test the workflow with real quotes at no cost.",
    features: [
      "20 quotes / month",
      "Email delivery",
      "1 follow-up per quote",
      "WinStream branding on documents",
    ],
  ...
  },
  {
    ...
    price: "R299",
    period: "per month",
    description: "For SMEs sending quotes weekly.",
    features: [
      "100 quotes / month",
      "WhatsApp + email quoting",
      "Remove WinStream branding",
  ...
  },
  {
    ...
    price: "R599",
    period: "per month",
    description: "Full pipeline from quote to paid invoice.",
    features: [
      "Unlimited quotes",
      "Full quote-to-invoice workflow",
      "POPIA client data export",
      "Priority support",
    ],
